...
transformed_data = np.array([[247.864,252.311,247.121,5.18984,29928300]])
...
while True:
    ...
    # Transform the latest data point (cleaning and normalizing)
    ...
    time.sleep(86400)  # Sleep for an hour before fetching the next data point
